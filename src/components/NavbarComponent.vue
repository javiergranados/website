...
<template>
  <nav class="sticky top-0 z-50 border-b border-primary/20 bg-base-100/95 backdrop-blur-sm">
    <div class="mx-auto flex h-16 max-w-5xl items-center px-4 md:px-8">
      <HamburgerMenu />
      <router-link to="/" class="mr-6 flex items-center gap-3 transition-opacity hover:opacity-80">
        <img alt="logo" :src="logoSrc" width="40" height="32" />
        <span class="hidden text-sm font-semibold text-primary md:block">Javier Granados</span>
      </router-link>
